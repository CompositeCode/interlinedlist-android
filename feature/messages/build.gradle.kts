...
android {
    namespace = "com.interlinedlist.android.feature.messages"
    compileSdk = 35
...
dependencies {
    ...
    // Avatars / message media thumbnails.
    ...
    // Repository tests exercise the real Retrofit stack against a local server.
